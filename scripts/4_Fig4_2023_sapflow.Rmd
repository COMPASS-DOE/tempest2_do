...
df_trim2 <- df_trim %>% 
  filter(doy >= 127 & doy <= 275) %>%  #127 is 30 days prior to flooding, 275 is a visual cutoff for end of the growing season
...
plot_grid(p1, p2, nrow = 1, 
          rel_widths = c(1, 0.7))
ggsave("../figures/250422_Figure4.png", width = 10, height = 7)
